    ...
    function (ccr, search, url, https) {
        ...
        const exportPdf = () => {
            ...
            let urlExportPdf = url.resolveScript({
                scriptId: 'customscript_scv_thh_sl_flow_sql_ssrch',
                deploymentId: 'customdeploy_scv_thh_sl_flow_sql_ssrch',
                returnExternalUrl: false, params: {isExportPdf: 'T'}
            })
            
            let body = getParameters(currentRecord);
            body.templateId = 'CUSTTMPL_SCV_TEST_ORDER_NEW';
            
            let resCall = https.post({
                url : urlExportPdf,
