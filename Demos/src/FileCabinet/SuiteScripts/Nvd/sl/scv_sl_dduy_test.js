...
define(
    ...
    function (
        ...
        const CustomDataConfig = {
            ...
            SS: {
                DOC_CREATE_ASSET: 'customsearch_scv_hinhthanhts_ccdc',
                DOC_RATE_FIX_ASSET : 'customsearch_scv_danhgia_tscd'
            },
            SUBLIST: {
        ...
        const onRequest = scriptContext => {
            scriptContext.response.write(JSON.stringify({
                data: search.load(CustomDataConfig.SS.DOC_CREATE_ASSET)
            }));
            return;
        ...
        const doGetForm = (scriptContext) => {
            ...
            form.clientScriptModulePath = "../cs/scv_cs_sl_create_fixed_asset.js";
        ...
        const handleData = objParams => {
            ...
            const resultDataOnHandLot = getDataDataOnHandLot({
         ...
         */
        const getDataDataOnHandLot = (objParams) => {
            let result = {response: null, error: null, isSuccess: false};
            try {
                let searchObj = search.load({id: CustomDataConfig.SS.DOC_CREATE_ASSET, type: search.Type.INVENTORY_BALANCE});
                if (objParams.itemId) {
                ...
                log.error("Error getDataDataOnHandLot: ", e);
